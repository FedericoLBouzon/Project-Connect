        ...
        <div class="col-5">
            <div class="form-control card card-body align-items-center">
                ...
                <div class="input-group">
                 ...
                 <div class="input-group">
            <asp:Button runat="server" CssClass="form-control btn btn-dark mt-3" Text="Registrate" PostBackUrl="/Sources/Pages/FrmRegistro.aspx" />
             </div>

            <asp:Button runat="server" CssClass="form-control mt-3" Text="Volver" PostBackUrl="/Sources/Pages/Layouts.cshtml" />
